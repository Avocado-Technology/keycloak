...
const keycloakConfig = new KeycloakConfig("avcd", {
  ...
  contaAzulPublicPath: cfg.contaAzulPublicPath,
  contaAzulYogaPublicHost: cfg.contaAzulYogaPublicHost,
  contaAzulYogaPublicPath: cfg.contaAzulYogaPublicPath,
  apiGatewayPublicHost: cfg.apiGatewayPublicHost,
  apiGatewayPublicPath: cfg.apiGatewayPublicPath,
  mcpPublicHost: cfg.mcpPublicHost,
